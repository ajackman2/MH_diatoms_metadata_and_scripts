...
seagrass = readRDS("C:/Users/siobh/OneDrive - The University Of British Columbia/Project - Seagrass_Montague_2021-03-07/galliano_seagrass_2021and2023/imput_data/MH_18S_filtered001percent_notrarefied_phyloseq.rds")
blast_mol_18S <- read.csv("C:/Users/siobh/OneDrive - The University Of British Columbia/Project - Seagrass_Montague_2021-03-07/galliano_seagrass_2021and2023/counting_data/05-15-24_blast_mol_18S")

##### REPLACE WITH UPDATED TAXONOMY ######
tax = blast_mol_18S[,c("ASVid", "domain", "phylum","order","genus","species","asv_id")]

tax = ddply(tax, c("ASVid", "domain", "phylum","order","genus","species","asv_id"),
            summarise,
...
##### MAKE THE TAXAPLOTS ######
alldata = subset(alldata, alldata$leaf_number !="NA")
## make the plot
ggplot(alldata, aes(x=as.character(Row.names), y=as.numeric(relativeabundance), 
  ...
  facet_nested(.~leaf_section+leaf_number, scales="free")+
  labs(y="Relative Abundance", x="Sample", fill="Taxa")

ggsave(filename = ("taxaplot_18S.pdf"), 
