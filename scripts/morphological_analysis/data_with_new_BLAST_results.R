...
# mol_18S = readRDS("counting_data/MH_18S_unfiltered_phyloseq.rds")
# mol_RBCL = readRDS("counting_data/MH_RBCL_unfiltered_phyloseq.rds")
...
# read in the files with the new blast results
...
write.csv(mol_18S, "counting_data/06-05-24__blast_mol_18S")
write.csv(mol_RBCL, "counting_data/06-05-24_blast_mol_RBCL")
