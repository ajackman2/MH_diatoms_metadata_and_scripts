...
# fix row 1655 and 1656
combined_diatom_data[1655, 43] <- 20
combined_diatom_data[1656, 43] <- 32

# replaces the NAs with zeros
combined_diatom_data <- mutate_all(combined_diatom_data, ~ifelse(is.na(.), 0, .))

# fix the master_diatom_data
...
# add cols for all of the diatoms mark found that we did not
